...
public class Bishop extends ChessPiece
{
  ...
  public String[] get_tiles(ChessPiece[][] board_, int[] new_pos)
  {
    ...
    int i = 1;
    while ((pos[0]+x_change*i>=0 && pos[0]+x_change*i < 8) && (pos[1]+x_change*i>=0 && pos[1]+x_change*i < 8)) 
    {
      System.out.println("X-Pos: "+String.valueOf(pos[0]+x_change*i));
      return_string_vector.add(board_[pos[0]+x_change*i][pos[1]+y_change*i].color);
      i++;
    }
